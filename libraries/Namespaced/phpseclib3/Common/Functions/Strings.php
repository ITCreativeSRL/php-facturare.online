...
namespace FacturareOnline\phpseclib3\Common\Functions;

use FacturareOnline\ParagonIE\ConstantTime\Base64;
use FacturareOnline\ParagonIE\ConstantTime\Base64UrlSafe;
use FacturareOnline\ParagonIE\ConstantTime\Hex;
use FacturareOnline\phpseclib3\Math\BigInteger;
use FacturareOnline\phpseclib3\Math\Common\FiniteField;
            ...
            switch ($format[$i]) {
                ...
                case 'i':
                    if (!$element instanceof BigInteger && !$element instanceof FiniteField\Integer) {
                        throw new \InvalidArgumentException('A FacturareOnline\phpseclib3\Math\BigInteger or FacturareOnline\phpseclib3\Math\Common\FiniteField\Integer object was expected.');
                    }
