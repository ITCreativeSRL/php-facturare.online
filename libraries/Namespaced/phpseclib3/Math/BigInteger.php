 ...
 * <code>
 * <?php
 *    $a = new \FacturareOnline\phpseclib3\Math\BigInteger(2);
 *    $b = new \FacturareOnline\phpseclib3\Math\BigInteger(3);
 *
 *    $c = $a->add($b);
 *
...
namespace FacturareOnline\phpseclib3\Math;

use FacturareOnline\phpseclib3\Exception\BadConfigurationException;
use FacturareOnline\phpseclib3\Math\BigInteger\Engines\Engine;
...
class BigInteger implements \JsonSerializable
{
    ...
    public static function setEngine($main, array $modexps = ['DefaultEngine'])
    {
        ...
        $fqmain = 'FacturareOnline\phpseclib3\\Math\\BigInteger\\Engines\\' . $main;
     ...
     * <code>
     * <?php
     *    $a = new \FacturareOnline\phpseclib3\Math\BigInteger('10');
     *    $b = new \FacturareOnline\phpseclib3\Math\BigInteger('20');
     *
