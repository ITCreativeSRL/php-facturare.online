...
namespace FacturareOnline\phpseclib3\Crypt\RSA;
...
use FacturareOnline\phpseclib3\Exception\UnsupportedFormatException;
use FacturareOnline\phpseclib3\File\ASN1;
use FacturareOnline\phpseclib3\File\ASN1\Maps\DigestInfo;
...
class PublicKey extends RSA implements Common\PublicKey
{
     ...
     * Exponentiate
     *
     * @param \FacturareOnline\phpseclib3\Math\BigInteger $x
     ...
     * @return bool|\FacturareOnline\phpseclib3\Math\BigInteger
     */
     ...
     *
     * @param \FacturareOnline\phpseclib3\Math\BigInteger $m
     * @return bool|\FacturareOnline\phpseclib3\Math\BigInteger
     */
