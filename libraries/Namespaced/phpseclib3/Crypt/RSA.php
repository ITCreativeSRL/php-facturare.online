 ...
 *
 * $private = \FacturareOnline\phpseclib3\Crypt\RSA::createKey();
...
use FacturareOnline\phpseclib3\Crypt\RSA\PrivateKey;
use FacturareOnline\phpseclib3\Crypt\RSA\PublicKey;
...
abstract class RSA extends AsymmetricKey
{
     ...
     *
     * @var \FacturareOnline\phpseclib3\Crypt\Hash
     */
    protected $mgfHash;
     ...
     *
     * @param bool|\FacturareOnline\phpseclib3\Math\BigInteger $x
     * @param int $xLen
     * @return bool|string
     */
     ...
     *
     * @param string $x
     * @return \FacturareOnline\phpseclib3\Math\BigInteger
     */
    ...
    public function withHash($hash)
    {
        ...
        // \FacturareOnline\phpseclib3\Crypt\Hash supports algorithms that PKCS#1 doesn't support.  md5-96 and sha1-96, for example.
