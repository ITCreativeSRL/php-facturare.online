...
use FacturareOnline\phpseclib3\Crypt\EC\BaseCurves\Prime as PrimeCurve;
use FacturareOnline\phpseclib3\Crypt\EC\BaseCurves\TwistedEdwards as TwistedEdwardsCurve;
use FacturareOnline\phpseclib3\Exception\BadConfigurationException;
...
abstract class XML
{
    ...
    /**
     * Returns an instance of \FacturareOnline\phpseclib3\Crypt\EC\BaseCurves\Base based
     * on the curve parameters
     *
     * @param \DomXPath $xpath
     * @return \FacturareOnline\phpseclib3\Crypt\EC\BaseCurves\Base|false
     */
    private static function loadCurveByParam(\DOMXPath $xpath)
    {
        ...
        if ($namedCurve->length == 1) {
            ...
            $curve = '\FacturareOnline\phpseclib3\Crypt\EC\Curves\\' . $name;
