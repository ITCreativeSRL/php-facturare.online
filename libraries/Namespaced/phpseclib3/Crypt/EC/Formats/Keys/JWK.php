...
namespace FacturareOnline\phpseclib3\Crypt\EC\Formats\Keys;

use FacturareOnline\phpseclib3\Common\Functions\Strings;
use FacturareOnline\phpseclib3\Crypt\Common\Formats\Keys\JWK as Progenitor;
use FacturareOnline\phpseclib3\Crypt\EC\BaseCurves\Base as BaseCurve;
...
use FacturareOnline\phpseclib3\Crypt\EC\Curves\secp256k1;
use FacturareOnline\phpseclib3\Crypt\EC\Curves\secp256r1;
use FacturareOnline\phpseclib3\Crypt\EC\Curves\secp384r1;
use FacturareOnline\phpseclib3\Crypt\EC\Curves\secp521r1;
...
abstract class JWK extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        $curve = '\FacturareOnline\phpseclib3\Crypt\EC\Curves\\' . str_replace('P-', 'nistp', $key->crv);
        $curve = new $curve();
     ...
     *
     * @param \FacturareOnline\phpseclib3\Crypt\EC\BaseCurves\Base $curve
     * @param \FacturareOnline\phpseclib3\Math\Common\FiniteField\Integer[] $publicKey
     * @return array
     */
     ...
     *
     * @param \FacturareOnline\phpseclib3\Math\BigInteger $privateKey
     * @param \FacturareOnline\phpseclib3\Crypt\EC\Curves\Ed25519 $curve
     * @param \FacturareOnline\phpseclib3\Math\Common\FiniteField\Integer[] $publicKey
