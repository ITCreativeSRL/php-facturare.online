 ...
 *
 * $private = \FacturareOnline\phpseclib3\Crypt\EC::createKey('secp256k1');
...
use FacturareOnline\phpseclib3\Crypt\EC\BaseCurves\Montgomery as MontgomeryCurve;
use FacturareOnline\phpseclib3\Crypt\EC\BaseCurves\TwistedEdwards as TwistedEdwardsCurve;
use FacturareOnline\phpseclib3\Crypt\EC\Curves\Curve25519;
use FacturareOnline\phpseclib3\Crypt\EC\Curves\Ed25519;
use FacturareOnline\phpseclib3\Crypt\EC\Curves\Ed448;
use FacturareOnline\phpseclib3\Crypt\EC\Formats\Keys\PKCS1;
use FacturareOnline\phpseclib3\Crypt\EC\Parameters;
use FacturareOnline\phpseclib3\Crypt\EC\PrivateKey;
use FacturareOnline\phpseclib3\Crypt\EC\PublicKey;
...
use FacturareOnline\phpseclib3\Exception\UnsupportedOperationException;
use FacturareOnline\phpseclib3\File\ASN1;
use FacturareOnline\phpseclib3\File\ASN1\Maps\ECParameters;
...
abstract class EC extends AsymmetricKey
{
     ...
     * Curve
     *
     * @var \FacturareOnline\phpseclib3\Crypt\EC\BaseCurves\Base
     */
    protected $curve;
     ...
     *
     * @var \FacturareOnline\phpseclib3\Math\BigInteger
     */
    protected $q;
     ...
     *
     * @param string $curve
     * @return \FacturareOnline\phpseclib3\Crypt\EC\PrivateKey
     */
    public static function createKey($curve)
    {
        ...
        $curve = '\FacturareOnline\phpseclib3\Crypt\EC\Curves\\' . $curveName;
