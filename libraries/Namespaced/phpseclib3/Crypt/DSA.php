 ...
 *
 * $private = \FacturareOnline\phpseclib3\Crypt\DSA::createKey();
...
use FacturareOnline\phpseclib3\Crypt\DSA\Parameters;
use FacturareOnline\phpseclib3\Crypt\DSA\PrivateKey;
use FacturareOnline\phpseclib3\Crypt\DSA\PublicKey;
...
abstract class DSA extends AsymmetricKey
{
     ...
     * @param int $L
     * @param int $N
     * @return \FacturareOnline\phpseclib3\Crypt\DSA|bool
     */
