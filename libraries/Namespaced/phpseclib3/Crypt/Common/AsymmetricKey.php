...
use FacturareOnline\phpseclib3\Exception\NoKeyLoadedException;
...
abstract class AsymmetricKey
{
    ...
    private static function loadPlugins($format)
    {
        if (!isset(self::$plugins[static::ALGORITHM][$format])) {
            ...
            foreach (new \DirectoryIterator(__DIR__ . '/../' . static::ALGORITHM . '/Formats/' . $format . '/') as $file) {
                ...
                $type = 'FacturareOnline\phpseclib3\Crypt\\' . static::ALGORITHM . '\\Formats\\' . $format . '\\' . $name;
     ...
     *
     * @param \FacturareOnline\phpseclib3\Math\BigInteger $v
     * @return string
     */
