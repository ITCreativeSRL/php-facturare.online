...
namespace FacturareOnline\phpseclib3\Crypt\Common\Formats\Keys;

use FacturareOnline\phpseclib3\Common\Functions\Strings;
use FacturareOnline\phpseclib3\Crypt\AES;
use FacturareOnline\phpseclib3\Crypt\DES;
use FacturareOnline\phpseclib3\Crypt\Random;
use FacturareOnline\phpseclib3\Crypt\RC2;
use FacturareOnline\phpseclib3\Crypt\RC4;
use FacturareOnline\phpseclib3\Crypt\TripleDES;
...
abstract class PKCS8 extends PKCS
{
     ...
     *
     * @return \FacturareOnline\phpseclib3\Crypt\Common\SymmetricKey
     * @param string $algo
     */
