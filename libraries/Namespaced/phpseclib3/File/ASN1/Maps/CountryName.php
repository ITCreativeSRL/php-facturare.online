...
abstract class CountryName
{
    const MAP = [
        ...
        // if class isn't present it's assumed to be \FacturareOnline\phpseclib3\File\ASN1::CLASS_UNIVERSAL or
        // (if constant is present) \FacturareOnline\phpseclib3\File\ASN1::CLASS_CONTEXT_SPECIFIC
