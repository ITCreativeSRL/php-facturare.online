 ...
 *
 *    $agent = new \FacturareOnline\phpseclib3\System\SSH\Agent();
 *
...
namespace FacturareOnline\phpseclib3\System\SSH;
...
use FacturareOnline\phpseclib3\Net\SSH2;
use FacturareOnline\phpseclib3\System\SSH\Agent\Identity;

/**
 * Pure-PHP ssh-agent client identity factory
 *
 * requestIdentities() method pumps out \FacturareOnline\phpseclib3\System\SSH\Agent\Identity objects
 *
 * @author  Jim Wigginton <terrafrost@php.net>
 */
class Agent
{
     ...
     * Default Constructor
     *
     * @return \FacturareOnline\phpseclib3\System\SSH\Agent
     * @throws \FacturareOnline\phpseclib3\Exception\BadConfigurationException if SSH_AUTH_SOCK cannot be found
     ...
     * Returns an array containing zero or more \FacturareOnline\phpseclib3\System\SSH\Agent\Identity objects
     *
     * @return array
     ...
     *
     * @param \FacturareOnline\phpseclib3\Net\SSH2 $ssh
     * @return bool
     */
