...
namespace FacturareOnline\phpseclib3\System\SSH\Agent;
...
use FacturareOnline\phpseclib3\System\SSH\Common\Traits\ReadBytes;

/**
 * Pure-PHP ssh-agent client identity object
 *
 * Instantiation should only be performed by \FacturareOnline\phpseclib3\System\SSH\Agent class.
 * This could be thought of as implementing an interface that FacturareOnline\phpseclib3\Crypt\RSA
...
class Identity implements PrivateKey
{
     ...
     * Set Public Key
     *
     * Called by \FacturareOnline\phpseclib3\System\SSH\Agent::requestIdentities()
     *
     * @param \FacturareOnline\phpseclib3\Crypt\Common\PublicKey $key
     */
     ...
     * Set Public Key
     *
     * Called by \FacturareOnline\phpseclib3\System\SSH\Agent::requestIdentities(). The key blob could be extracted from $this->key
