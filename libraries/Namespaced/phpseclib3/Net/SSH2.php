 ...
 *
 *    $ssh = new \FacturareOnline\phpseclib3\Net\SSH2('www.domain.tld');
 ...
 *    include 'vendor/autoload.php';
 *
 *    $key = \FacturareOnline\phpseclib3\Crypt\PublicKeyLoader::load('...', '(optional) password');
 *
 *    $ssh = new \FacturareOnline\phpseclib3\Net\SSH2('www.domain.tld');
...
namespace FacturareOnline\phpseclib3\Net;

use FacturareOnline\phpseclib3\Common\Functions\Strings;
use FacturareOnline\phpseclib3\Crypt\Blowfish;
use FacturareOnline\phpseclib3\Crypt\ChaCha20;
use FacturareOnline\phpseclib3\Crypt\Common\AsymmetricKey;
use FacturareOnline\phpseclib3\Crypt\Common\PrivateKey;
use FacturareOnline\phpseclib3\Crypt\Common\PublicKey;
use FacturareOnline\phpseclib3\Crypt\Common\SymmetricKey;
use FacturareOnline\phpseclib3\Crypt\DH;
use FacturareOnline\phpseclib3\Crypt\DSA;
use FacturareOnline\phpseclib3\Crypt\EC;
use FacturareOnline\phpseclib3\Crypt\Hash;
use FacturareOnline\phpseclib3\Crypt\Random;
use FacturareOnline\phpseclib3\Crypt\RC4;
use FacturareOnline\phpseclib3\Crypt\Rijndael;
use FacturareOnline\phpseclib3\Crypt\RSA;
use FacturareOnline\phpseclib3\Crypt\TripleDES; // Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use FacturareOnline\phpseclib3\Crypt\Twofish;
use FacturareOnline\phpseclib3\Exception\ConnectionClosedException;
use FacturareOnline\phpseclib3\Exception\InsufficientSetupException;
use FacturareOnline\phpseclib3\Exception\NoSupportedAlgorithmsException;
use FacturareOnline\phpseclib3\Exception\UnableToConnectException;
use FacturareOnline\phpseclib3\Exception\UnsupportedAlgorithmException;
use FacturareOnline\phpseclib3\Exception\UnsupportedCurveException;
use FacturareOnline\phpseclib3\Math\BigInteger;
use FacturareOnline\phpseclib3\System\SSH\Agent;
...
class SSH2
{
     ...
     *     the other side.
     *
     * @see \FacturareOnline\phpseclib3\Net\SSH2::send_channel_packet()
     * @see \FacturareOnline\phpseclib3\Net\SSH2::get_channel_packet()
     */
     ...
     *
     * @see \FacturareOnline\phpseclib3\Net\SSH2::getLog()
     */
    const LOG_SIMPLE = 1;
    /**
     ...
     *
     * @see \FacturareOnline\phpseclib3\Net\SSH2::read()
     */
    const READ_SIMPLE = 1;
    /**
     ...
     * @throws \UnexpectedValueException on receipt of unexpected packets
     * @throws \RuntimeException on other errors
     * @throws \FacturareOnline\phpseclib3\Exception\NoSupportedAlgorithmsException when none of the algorithms phpseclib has loaded are compatible
     */
     ...
     * \FacturareOnline\phpseclib3\Crypt\Common\SymmetricKey.
     *
     * @param string $algorithm Name of the encryption algorithm
    ...
    /**
     * Maps an encryption algorithm name to an instance of a subclass of
     * \FacturareOnline\phpseclib3\Crypt\Hash.
     *
     * @param string $algorithm Name of the encryption algorithm
     ...
     * Login
     *
     * The $password parameter can be a plaintext password, a \FacturareOnline\phpseclib3\Crypt\RSA|EC|DSA object, a \FacturareOnline\phpseclib3\System\SSH\Agent object or an array
     *
        ...
        foreach ($args as $arg) {
            switch (true) {
                ...
                case Strings::is_stringable($arg):
                    break;
                default:
                    throw new \UnexpectedValueException('$password needs to either be an instance of \FacturareOnline\phpseclib3\Crypt\Common\PrivateKey, \System\SSH\Agent, an array or a string');
            }
        }
     ...
     *
     * @param string $username
     * @param \FacturareOnline\phpseclib3\System\SSH\Agent $agent
     * @return bool
     */
     ...
     *
     * @param string $username
     * @param \FacturareOnline\phpseclib3\Crypt\Common\PrivateKey $privatekey
     * @return bool
     * @throws \RuntimeException on connection error
     */
        ...
        if ($publickey instanceof RSA) {
            ...
            switch ($curveName) {
                ...
                default:
                    ...
                    throw new UnsupportedCurveException('Named Curve of ' . $curveName . ' is not supported by FacturareOnline\phpseclib3\'s SSH2 implementation');
            }
     ...
     * Set Timeout
     *
     * $ssh->exec('ping host.docker.internal'); on a Linux host will never return and will run indefinitely.  setTimeout() makes it so it'll timeout.
     ...
     * Execute Command
     *
     * If $callback is set to false then \FacturareOnline\phpseclib3\Net\SSH2::get_channel_packet(self::CHANNEL_EXEC) will need to be called manually.
    ...
    public function exec($command, callable $callback = null)
    {
        ...
        // down.  the one place where it might be desirable is if you're doing something like \FacturareOnline\phpseclib3\Net\SSH2::exec('ping localhost &').
     ...
     *
     * \FacturareOnline\phpseclib3\Net\SSH2 doesn't properly close most channels.  For exec() channels are normally closed by the server
     ...
     * @throws \FacturareOnline\phpseclib3\Exception\NoSupportedAlgorithmsException when the key isn't in a supported format
     */
