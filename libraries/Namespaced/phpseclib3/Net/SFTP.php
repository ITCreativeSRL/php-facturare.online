 ...
 *
 *    $sftp = new \FacturareOnline\phpseclib3\Net\SFTP('www.domain.tld');
...
use FacturareOnline\phpseclib3\Exception\FileNotFoundException;
...
class SFTP extends SSH2
{
     ...
     *
     * \FacturareOnline\phpseclib3\Net\SSH2::exec() uses 0 and \FacturareOnline\phpseclib3\Net\SSH2::read() / \FacturareOnline\phpseclib3\Net\SSH2::write() use 1.
     *
     ...
     *
     * @see \FacturareOnline\phpseclib3\Net\SFTP::put()
     */
    ...
    public function __construct($host, $port = 22, $timeout = 10)
    {
        ...
        // the order, in this case, matters quite a lot - see \FacturareOnline\phpseclib3\Net\SFTP::_parseAttributes() to understand why
        $this->attributes = [
        ...
        // see \FacturareOnline\phpseclib3\Net\SFTP::_parseLongname() for an explanation
        $this->file_types = [
    ...
    private function init_sftp_connection()
    {
        ...
        /*
         ...
         in draft-ietf-secsh-filexfer-13 would be quite impossible.  As such, what \FacturareOnline\phpseclib3\Net\SFTP would do is close the
    ...
    public function chdir($dir)
    {
        ...
        // see \FacturareOnline\phpseclib3\Net\SFTP::nlist() for a more thorough explanation of the following
        $response = $this->get_sftp_packet();
        switch ($this->packet_type) {
     ...
     * Returns general information about a file or symbolic link
     *
     * Determines information without calling \FacturareOnline\phpseclib3\Net\SFTP::realpath().
     ...
     *
     * By default, \FacturareOnline\phpseclib3\Net\SFTP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
     * So, for example, if you set $data to 'filename.ext' and then do \FacturareOnline\phpseclib3\Net\SFTP::get(), you will get a file, twelve bytes
     ...
     *
     * {@internal ASCII mode for SFTPv4/5/6 can be supported by adding a new function - \FacturareOnline\phpseclib3\Net\SFTP::setMode().}
     *
     ...
     * @throws \FacturareOnline\phpseclib3\Exception\FileNotFoundException if you're uploading via a file and the file doesn't exist
     * @return bool
     */
