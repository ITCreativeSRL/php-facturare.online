...
class Curl extends AbstractRetriever
{
     ...
     * {@inheritdoc}
     *
     * @see \FacturareOnline\JsonSchema\Uri\Retrievers\UriRetrieverInterface::retrieve()
     */
    public function retrieve($uri)
    {
        ...
        if (false === $response) {
            throw new \FacturareOnline\JsonSchema\Exception\ResourceNotFoundException('JSON schema not found');
        }
